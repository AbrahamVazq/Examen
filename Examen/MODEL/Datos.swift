...
class DataMusic {
    ...
    func setAlbums() -> [Album]{
        ...
        let frankCycles = Album(art: "Frank Sinatra", nam: "Cycles", yr: "1968", sg: ["Rain in my heart", "Both sides now", "Little green apples", "Pretty colors", "Cycles", "wandering", "By the time I get to Phoenix", "Moody river", "My way of life", "Gentle on my mind"])
        let billieWhere = Album(art: "Billie Eilish", nam: "WWAFAWDWG", yr: "2019", sg: ["!!!!!!!!", "bad guy", "xanny", "you should see me in a crown", "all the good girls go to hell", "wish you were gay", "when the party's over", "8", "My strange addiction", "bury a friend", "ilomilo", "listen before i go", "i love you", "goodbye"])
